...
<body>
	<div class="purchaseWrap">
		<header>
			<div class="header">
				<a class="beforeButton"><img src="${pageContext.request.contextPath}/resources/img/button/sfix_header.png" alt="afterButton"></a>마이리움
			</div>
			...
			<div class="orderInfoWrap">
				...
				<div class="orderInfoContent">
					<table>
						<tr>
							<th>주문자</th>
							<td><input type="text" class="bigTextBox" value="${memberInfo.customerName}"></td>
						</tr>
						<tr>
							<th class="addressTopTh" rowspan="3">주소</th>
							<td><input type="text" class="addressTop" value="${memberInfo.zipcode}" readonly> <input type="button" class="addressSearchButton" value="주소검색"></td>
						</tr>
						<tr>
							<td><input type="text" class="bigTextBox" value="${memberInfo.addr1}" readonly></td>
						</tr>
						<tr>
							<td><input type="text" class="bigTextBox" value="${memberInfo.addr2}"></td>
						</tr>
						<tr>
							<th>휴대전화</th>
							<td><input type="text" class="phoneTextBox" value="${fn:split(memberInfo.phoneNumber, '-')[0]}"> - <input type="text" class="phoneTextBox" value="${fn:split(memberInfo.phoneNumber, '-')[1]}"> - <input type="text" class="phoneTextBox" value="${fn:split(memberInfo.phoneNumber, '-')[2]}"></td>
						</tr>
					</table>
				</div>
			...
			<div class="orderProductWrap">
				...
				<div class="orderProduct">
						...
						<table style="border-bottom: 1px dashed #E9E9E9; width: 100%;">
							<tr>
								...
								<td>
									...
									<p style="color: #888; margin-bottom: 10px;">수량 : ${item.inCart.quantity}개</p>
					...
					<div class="totalPriceWrap">
						<span>배송비</span> <span style="float: right; font-weight: 600;">3,000원</span>
					</div>
				</div>
			</div>
			<!-- 배송비 끝 -->
